...
(function ($, Drupal, drupalSettings) {
    ...
    if (item.fields) {
      $.each(item.fields, function(key, value) {
        ...
        if (key === 'featured_image') {
            output = '<img class="ui-autocomplete-field-' + key + '" src="'+value+'" />';            
        }else if (key === 'created') {
            created = '<span class="ui-autocomplete-field-' + key + '">'+value+'</span>';  
            output = '';
      ...
      if (item.group && item.group.group_id != 'more_results' && item.group.group_id != 'no_results') {
        output = '<span class="ui-autocomplete-field-term">' + item.label + '</span>';
      }
   ...
   */
  function resizeMenu(id, w) {
    var ul = $('#'+id);
    ul.css( "maxWidth", w+"px" );
  }
  ...
  Drupal.behaviors.autocomplete = {
	...
	value = $(value);
        ...
        if (value.length) {
          ...
          if (value.data("key")) {
            resizeMenu(value.autocomplete("widget").attr("id"),value.parents('.region').innerWidth());
