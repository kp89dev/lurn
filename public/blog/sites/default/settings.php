 ...
 * @endcode
 */
$settings['hash_salt'] = 'RqCz9WDMZLf7mFYLPqlqzVEgg1bFfJ61xiZpvxOd4wa-QIrdTj-euywdNUCn1s-zg5bPnMGoEg';
...
$settings['file_public_base_url'] = 'http://cdn.lurn.com';
...
$settings['file_public_path'] = '../static/blog/files';
$settings['php_storage']['twig']['directory'] = '../static/blog/files';

$config['s3fs.settings']['access_key'] = 'AKIAIK2MBR6H3VTL65FQ';
$config['s3fs.settings']['secret_key'] = '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';

$config['s3fs.settings']['bucket'] = 'lurn-nation-static';
...
$config['s3fs.settings']['domain'] = 'cdn.lurn.com';
...
// If you want enable private system for S3
...
$config_directories['sync'] = '../../drupal/config/sync';
$databases['default']['default'] = array (
  'database' => 'lurn_central_blog',
  'username' => 'root',
  'password' => '',
  'prefix' => '',
  'host' => 'localhost',
